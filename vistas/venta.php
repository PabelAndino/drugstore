                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border shadow-lg">
                                <h1 class="p-3 mb-2 bg-green-gradient text-white shadow-sm">Venta </h1>
                            ...
                            <div class="panel-body"  id="formularioregistros">  <!--style="height: 800px;"-->
                                ...
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <button id="fiado" type="button" class="btn btn-warning active" onclick="calculaCredito()"> <span class="fa fa-bank"></span> Crédito</button>
                                            <!--<button id="fiado" type="button" class="btn btn-flickr active" onclick="calculaCredito()"> <span class="fa fa-connectdevelop"></span> Reparación</button>-->
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                        <span class="badge badge-dark">Detalles</span>
